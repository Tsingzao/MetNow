...
from models.vp_suite.utils.utils import set_from_kwarg, get_public_attrs
from models.vp_suite.measure.loss_provider import PredictionLossProvider
from models.vp_suite.base import VPData
...
class VPModel(nn.Module):
    ...
    action_size = 0  #: The expected dimensionality of the action inputs.
