...
from models.segformer.layers import DropPath
...
class PVTv2(nn.Module):     
    def __init__(self, model_name: str = 'B1', num_inchannels: int = 3) -> None:
        super().__init__()
        ...
        # patch_embed
        self.patch_embed1 = PatchEmbed(num_inchannels, embed_dims[0], 7, 4)
